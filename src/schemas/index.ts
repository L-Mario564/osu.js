...
export const getSelfOptionsSchema = z.object({
  urlParams: z.object({
...
export const getUserKudosuOptionsSchema = z.object({
...
export const getUserScoresOptionsSchema = z.object({
  query: z.object(getUserScoresOptions)
}).deepPartial().optional();

export const getUserRecentScoresOptionsSchema = z.object({
  query: z.object({
...
export const getUserBeatmapsOptionsSchema = z.object({
  query: z.object(baseQuery)
}).deepPartial().optional();
...
export const getUserRecentActivityOptionsSchema = z.object({
  query: z.object(baseQuery)
}).deepPartial().optional();
