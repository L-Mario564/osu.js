...
export const getDiscussionPostsOptionsSchema = z.object({
  query: z.object({
    ... baseQuerySchema,
...
export const getDiscussionVotesOptionsSchema = z.object({
  query: z.object({
    ... baseQuerySchema,
    /** ID of the beatmapset discussion */
    beatmapset_discussion_id: z.number(),
...
export const getDiscussionsOptionsSchema = z.object({
  query: z.object({
    ... baseQuerySchema,
