...
describe('Test mod-enum conversion', () => {
  ...
  it('(Mod -> Enum) NCPF + 1 mod', () => expect(getEnumMods(17000)).toStrictEqual(['HD', 'NC', 'PF']));
  ...
  it('(Enum -> Mod) NCPF + 1 mod', () => expect(getModsEnum(['HD', 'NC', 'PF'])).toStrictEqual(16904));
  ...
  it('(Enum -> Mod) (DT)NC + 1 mod', () => expect(getModsEnum(['HD', 'NC'], true)).toStrictEqual(584));
  it('(Enum -> Mod) (SD)PF + 1 mod', () => expect(getModsEnum(['HD', 'PF'], true)).toStrictEqual(16424));
  it('(Enum -> Mod) (DT)NC(SD)PF', () => expect(getModsEnum(['NC', 'PF'], true)).toStrictEqual(16992));
  it('(Enum -> Mod) (DT)NC(SD)PF + 1 mod', () => expect(getModsEnum(['HD', 'NC', 'PF'], true)).toStrictEqual(17000));
